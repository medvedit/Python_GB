...
name1 = '\"Sergey\"' # Обратные опострафы работают так же, как и языке C# => \", \n, \t ...
print(name1) # => "Sergey"
print(name) # => Sergey
...
print(nam, namm, str) # => 123 1.47 Hello world
print(nam, '-', namm, '-', str) # => 123 - 1.47 - Hello world
print('{} - {} - {}'. format(nam, namm, str)) # => 123 - 1.47 - Hello world
print('{0} - {2} - {1}'. format(nam, namm, str)) # => 123 - Hello world - 1.47
print(f'{nam} - {namm} - {str}') # => 123 - 1.47 - Hello world
...
print('Введите l: ')  # Просим ввести значение. => 5
...
print(f'{d} {l}') # => 9 5
print(l, '+', d, '=', l+d) # Но в выводе мы получим строку 5 + 9 = 59. Про сложение смотрим ниже по строкам..
# Сложение в выводе:
print('Введите q: ') # => 5
