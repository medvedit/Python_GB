...
# Далее по коде меняем значение одоц переменной в list1 и получаем изменение в list2
print()
...
print(len(colors)) #  3  Распечатали длинну/колличетсво элементов в списке
print(type(colors)) # <class 'list'>

colors1 = colors # Создали новый список colors1 равный первому colors
print(len(colors1)) #  3  Распечатали длинну/колличетсво элементов в списке
...
#                                                                !!!!!!!  ВАЖНО ЧТО ЭЛЕМЕНТЫ ДИНАМИЧЕСКИ МКНЯЮТСЯ ВО ВСХ СИСКАХ !!!!!!!
...
colors1.pop(1) # Удалит элемент в агументом 1 из списка colors1
