...
data.writelines(colors) # Заносим текст из переменной colors, разделителей не будет.
                        # При повторном запуске, данные будут дописываться.
data.write('\n112233\n')
data.write('445566\n')
data.close() # Закрываем, разрываем связь с файлом file.txt .
# ***********************************
...
import Lecture_1 as L # обращяемся к соседнему файлу + к которому создали ассоциацию как буква L и ниже уже обращяемся по букве L
...
def new_string(symbol, count): # Предположим есть функция принимающяя на вход символ и число
    return symbol * count  # на выходе мы умножаем символ на число

print(new_string('!', 5))     # !!!!!
print(new_string('!'))        # TypeError missing 1 required ... тк нет второго входящего элемента

def new_string(symbol, count = 3): # можно присвоить число сразу и если не вводим число на вывод, будет использоваться три.
    return symbol * count
print(new_string('!', 5)) # !!!!!
print(new_string('!')) # !!!
...
# ******************************************
#  Возможность передачи не ограниченного количества аргументов:

def concatenation(*params): # Создали функцию со звездочкой перед аргументом
    res: str = "" # работа со строками
...
def concatenation(*params): # Создали функцию со звездочкой перед аргументом
    ...
    return res # результат
# print(concatenation('a', 's', 'd', 'w')) # TypeError: ...
# print(concatenation('a', '1', 'd', '2')) # TypeError: ...
print(concatenation(1, 2, 3, 4)) # 10
# ******************************************
# ================================================================================================== Рекурсия =================================================================================================================================

def fib(n): # функция вычесления Фибоначчи
    if n in [1, 2]:
        return 1
    else:
...
for i in range(1, 10): # прошли циклом в заданном рендже
...
print(a[0])    # в кортеже можно обращятся к элементу - 2
print(a[-1])   # 4
# **********************************************
t = ()
print(type(t)) # tuple
...
t[0] = 'black' # TypeError: 'tuple' object does not support item assignment Явно изменить или присвоить значение элемента в кортеже мы не можем  !!!!!!!!!!!!!!!!!!!!!!!!!!
# **********************************************
...
print()
a.add(4) # хочу добавить 4. И тк его не было ранее в множестве, 4 добавляется.
print(a) # {1, 2, 3, 4, 5, 8}
print()
b.add('red')
...
# *******************************************************************
# Копирование и обьединение множеств:
...
# *********************************************************************
# Пересичение, разница и разница + пересичение:
