...
a = [1, 2, 'stroke', True] # Создали список a.
b = [34, 43, 12, 2] # Создали список b.
a.append(22) # Добавили в список а  значение 22. добавляется в конец списка.
print(a) # [1, 2, 'stroke', True, 22]
a.append(b) # Добавили в список a список b. Добавляется списком! В конец списка a.
print(a) # [1, 2, 'stroke', True, 22, [34, 43, 12, 2]]
a.append(2) # Добавили в список a значение 2.
print(a) # [1, 2, 'stroke', True, 22, [34, 43, 12, 2], 2]
print(a.count(2)) # 2    (С помощью метода .count(аргумент), посчитали количество значения 2
...
a = [1, 2, 'stroke', True, 22, [34, 43, 12, 2], 2]
b = [34, 43, 12, 2]
a.extend(b) # Метод добавил и распаковал список b в конец существующего списка a
print(a) # # [1, 2, 'stroke', True, 22, [34, 43, 12, 2], 2, 34, 43, 12, 2]
...
del my_list[1:6] # Чтобы удалить несколько элементов, при объявлении, stop может уходить за пределы списка.
...
count = list_in.count('Apple') # Считаем сколько раз слово Apple встречается в списке list_in
                                  # и заносим количество в переменную list_out
print(f'Слово Apple встречается {count} раз(а)') # Слово Apple встречается 3 раз(а)


list_in = [ ['Rat','Cat'], ['Heat','Beat'], ['Rat','Cat'] ]
count = list_in.count(['Rat','Cat']) # Считаем сколько раз список ['Rat','Cat'] встречается в списке list_in
                                        # и заносим количество в переменную list_out
print(f"Список ['Rat','Cat'] встречается {count} раз(а)") # Список ['Rat','Cat'] встречается 2 раз(а)
...
# # Пример 2: При отсутствии элемента в списке
# # vowels list
# vowels = ['a', 'e', 'i', 'o', 'u']
...
while data_list:
    ...
    data_list.remove(minimum) # удаляем наименьший элемент в начальном списке и
                              # возвращаемся к поиску нового наименьшего в цикле for, по начальному списку.
...
# то отрисовка производится по первому элементу вложенного списка.
...
persons = [['Alice', 26, 'F'], ['Trudy', 25, 'M'], ['Bob', 25, 'M'], ['Alexia', 22, 'F']]
print(f'До сортировки: {persons}') # До сортировки: [['Alice', 26, 'F'], ['Trudy', 25, 'M'], ['Bob', 25, 'M'], ['Alexia', 22, 'F']]
persons.sort(key=custom_key)
print(f'После сортировки: {persons}') # После сортировки: [['Alexia', 22, 'F'], ['Trudy', 25, 'M'], ['Bob', 25, 'M'], ['Alice', 26, 'F']]
