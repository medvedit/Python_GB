...
str_2 = input('Введите какое вождение нуно отыкать в первой строке,\n'
            ' а я выведу цифру, скольуо раз это вхохдение присутствует в первой строке:') # po

print(str_1.count(str_2)) # 3

a = input('Введите первую строку:') # giPOpopotame
b = input('Введите какое вождение нуно отыкать в первой строке,\n'
            ' а я выведу цифру, скольуо раз это вхохдение присутствует в первой строке:') # po
...
# Задача №11 ---------------------------------------------------------
# Напишите программу, котрорая на вход принимает два числа. Получите значение N, для пустого списка, заполните
# числами в диапозоне [- N, N]. Найдите произведение элементов на указанных позициях(не индексах).
